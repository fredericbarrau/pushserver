...
mongoose.model(collectionsName.application, applicationSchema)["_modelName"] = 'application';
mongoose.model(collectionsName.application, applicationSchema)["_collectionName"] = 'applications';

mongoose.model(collectionsName.target, targetSchema)["_modelName"] = 'target';
mongoose.model(collectionsName.target, targetSchema)["_collectionName"] = 'targets';

mongoose.model(collectionsName.device, deviceSchema)["_modelName"] = 'device';
mongoose.model(collectionsName.device, deviceSchema)["_collectionName"] = 'devices';

mongoose.model(collectionsName.push, pushSchema)["_modelName"] = 'push';
